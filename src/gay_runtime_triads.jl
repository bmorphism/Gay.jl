...
# Stub definitions
struct Runtime end
struct RuntimeWorld end
struct RuntimeTriad end
struct RuntimeMonad end
unit_runtime(args...; kwargs...) = nothing
multiply_runtime(args...; kwargs...) = nothing
struct UnworldingFunctor end
unworld(args...; kwargs...) = nothing
escape_to_runtime(args...; kwargs...) = nothing
spi_score(args...; kwargs...) = nothing
synergy_score(args...; kwargs...) = nothing
pairwise_distance(args...; kwargs...) = nothing
select_optimal_triad(args...; kwargs...) = nothing
rank_triads(args...; kwargs...) = nothing
enumerate_triads(args...; kwargs...) = nothing
compare_ohmythreads_loom(args...; kwargs...) = nothing

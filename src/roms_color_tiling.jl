...
struct ColorTiling end
struct ColorTile end
create_color_tiling(args...; kwargs...) = nothing
create_tile(args...; kwargs...) = nothing
compute_tile_colors!(args...; kwargs...) = nothing
tile_neighbors(args...; kwargs...) = nothing

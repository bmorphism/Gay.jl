...
struct SeedNode end
struct SeedCluster end
struct ClusterBoundary end
struct SeedMorphism end
struct MiningConfig end
struct MiningStats end
mine_seeds_simd(args...; kwargs...) = nothing
mine_seeds_parallel!(args...; kwargs...) = nothing
mine_batch!(args...; kwargs...) = nothing
auto_cluster!(args...; kwargs...) = nothing
compute_boundary!(args...; kwargs...) = nothing
glue_acsets!(args...; kwargs...) = nothing
sheaf_condition(args...; kwargs...) = nothing
create_morphism!(args...; kwargs...) = nothing
is_valid_morphism(args...; kwargs...) = nothing
lookup_blessed(args...; kwargs...) = nothing
pareto_frontier(args...; kwargs...) = nothing
insert_blessed!(args...; kwargs...) = nothing
seed_distance(args...; kwargs...) = nothing

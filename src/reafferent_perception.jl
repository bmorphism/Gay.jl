...
spectrum_t(args...; kwargs...) = nothing
find_continuation(args...; kwargs...) = nothing
struct GaloisClosure end
struct COLOR_CLOSURE end
apply_closure(args...; kwargs...) = nothing
apply_kernel(args...; kwargs...) = nothing
functionality_at(args...; kwargs...) = nothing
struct ReafferentLoop end
run_reafferent_loop(args...; kwargs...) = nothing
struct AperiodicReafference end
can_match(args...; kwargs...) = nothing
struct GENESIS_COLOR end
struct TIP_COLOR end
struct GALOIS_FIXED_POINTS end
struct FUNCTIONALITY_CATEGORIES end

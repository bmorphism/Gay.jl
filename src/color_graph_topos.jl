...
struct ColorEdge end
struct ColorGraph end
load_color_graph(args...; kwargs...) = nothing
struct GraphTile end
struct GraphWiringDiagram end
struct GraphOrbit end
struct GraphToposData end
build_topos(args...; kwargs...) = nothing
create_tiles(args...; kwargs...) = nothing
create_wiring_diagram(args...; kwargs...) = nothing
extract_orbits(args...; kwargs...) = nothing

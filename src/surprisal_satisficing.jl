...
struct Satisfice end
struct SurprisalSatisficer end
struct TritwiseMotif end
tritwise_match(args...; kwargs...) = nothing
frontrun_motifs(args...; kwargs...) = nothing
struct CoCone end
cocone_complete(args...; kwargs...) = nothing
reverse_flow(args...; kwargs...) = nothing
struct Cone end
struct TwoColoredOperad end
struct FCDProp end

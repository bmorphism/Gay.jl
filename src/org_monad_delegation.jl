...
# Stub definitions
struct Subagent end
struct DelegationPlan end
struct CredibleCommitment end
struct PendingCommitment end
struct OptimisticExecution end
delegate_with_tiebreaker!(args...; kwargs...) = nothing
execute_optimistically!(args...; kwargs...) = nothing
struct OrgMonad end

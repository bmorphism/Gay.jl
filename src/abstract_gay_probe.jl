...
struct ProbeResult end
struct ProbeComposite end
struct SyntheticProbe end
struct ReafferentProbe end
struct PathInvarianceProbe end
struct SPIProbe end
probe(args...; kwargs...) = nothing
compose_probes(args...; kwargs...) = nothing
decompose_probe(args...; kwargs...) = nothing
reafferent_saturation(args...; kwargs...) = nothing

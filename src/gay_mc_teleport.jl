...
struct TeleportState end
struct GaloisGadget end
struct ThreeMatchEdge end
seed_at(args...; kwargs...) = nothing
color_at(args...; kwargs...) = nothing
teleport!(args...; kwargs...) = nothing
lateral_move!(args...; kwargs...) = nothing
interleave!(args...; kwargs...) = nothing
precompute_bundle!(args...; kwargs...) = nothing
is_bundle_ready(args...; kwargs...) = nothing
struct GaloisConnection end
best_gadget(args...; kwargs...) = nothing
rewrite_edge!(args...; kwargs...) = nothing
verify_closure(args...; kwargs...) = nothing

...
# Stub definitions
struct GHAgent end
struct GHOperation end
struct GHResult end
struct GHAgency end
gh_api(args...; kwargs...) = nothing
gh_issue(args...; kwargs...) = nothing
gh_pr(args...; kwargs...) = nothing
gh_repo(args...; kwargs...) = nothing
gh_search(args...; kwargs...) = nothing
parallel_gh!(args...; kwargs...) = nothing
run_agency!(args...; kwargs...) = nothing
agent_color(args...; kwargs...) = nothing
struct GHProbe end

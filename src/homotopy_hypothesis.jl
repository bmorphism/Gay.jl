...
struct NCell end
struct CellColony end
struct Thing end
struct Process end
struct MetaProcess end
make_thing(args...; kwargs...) = nothing
make_process(args...; kwargs...) = nothing
make_metaprocess(args...; kwargs...) = nothing
make_ncell(args...; kwargs...) = nothing
fundamental_groupoid(args...; kwargs...) = nothing
path_color(args...; kwargs...) = nothing
homotopy_color(args...; kwargs...) = nothing
struct BadStudent end
struct GoodTeacher end
learn_from_confusion!(args...; kwargs...) = nothing
confusion_gradient(args...; kwargs...) = nothing
struct ChebyshevCoherence end
chebyshev_level(args...; kwargs...) = nothing
coherence_error(args...; kwargs...) = nothing
approximate_homotopy(args...; kwargs...) = nothing
chebyshev_T(args...; kwargs...) = nothing
polynomial_metaprocess(args...; kwargs...) = nothing
struct HomotopyWalk end
walk_groupoid!(args...; kwargs...) = nothing

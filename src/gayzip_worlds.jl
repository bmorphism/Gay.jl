...
# Stub definitions
struct GayWorld end
struct WorldMorphism end
struct SemanticFreedom end
struct GAYZIP_WORLDS end
all_worlds(args...; kwargs...) = nothing
resolve_path(args...; kwargs...) = nothing
reach_world(args...; kwargs...) = nothing
canonical_projection(args...; kwargs...) = nothing

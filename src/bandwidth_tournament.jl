...
bandwidth_score(args...; kwargs...) = nothing
struct TournamentMatch end
...
struct TRIT_NEG end
struct TRIT_ZERO end
struct TRIT_POS end
color_to_trits(args...; kwargs...) = nothing
trit_xor(args...; kwargs...) = nothing
trit_neg(args...; kwargs...) = nothing
trit_string(args...; kwargs...) = nothing

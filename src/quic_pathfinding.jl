...
struct QUICPathCandidate end
probe_pathfind!(args...; kwargs...) = nothing
validate_path_selection!(args...; kwargs...) = nothing
struct QUICPathContext end
sweep_probe!(args...; kwargs...) = nothing
measure_probes!(args...; kwargs...) = nothing
struct MultipathSelector end
rank_paths(args...; kwargs...) = nothing
select_active_paths!(args...; kwargs...) = nothing

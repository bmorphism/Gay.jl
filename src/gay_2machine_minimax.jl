...
struct GayCompute end
struct Machine end
struct TwoMachine end
propose!(args...; kwargs...) = nothing
respond!(args...; kwargs...) = nothing
find_equilibrium!(args...; kwargs...) = nothing
struct GayProbe end
struct PriorityMarket end
struct ConfidentialCommitment end
probe_priority!(args...; kwargs...) = nothing
reveal_priority!(args...; kwargs...) = nothing
struct ColorOp end
struct PrioritySubstrate end
rank_substrates(args...; kwargs...) = nothing

...
struct AbstractColorgrade end
struct CRDTOrdering end
struct LessThan end
struct Equal end
struct GreaterThan end
struct Concurrent end
struct GayColorgrade end
struct PlainColorgrade end
colorgrade_gay(args...; kwargs...) = nothing
colorgrade_plain(args...; kwargs...) = nothing
verify_merge(args...; kwargs...) = nothing
verify_laws(args...; kwargs...) = nothing
struct CRDTLawViolation end
struct GCounter end
struct PNCounter end
struct GSet end
struct ORSet end

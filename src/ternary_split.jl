...
split_seed(args...; kwargs...) = nothing
split_n(args...; kwargs...) = nothing
seed_lineage(args...; kwargs...) = nothing
struct TernaryColor end
ternary_from_seed(args...; kwargs...) = nothing
split_color(args...; kwargs...) = nothing
color_components(args...; kwargs...) = nothing
recombine_color(args...; kwargs...) = nothing
struct TernaryWalk end
struct TernaryWalkBatch end
parallel_ternary_walks(args...; kwargs...) = nothing
merge_walks(args...; kwargs...) = nothing
struct COIState end
fork_state(args...; kwargs...) = nothing
merge_states(args...; kwargs...) = nothing
verify_ternary_spi(args...; kwargs...) = nothing

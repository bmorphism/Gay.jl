...
struct Gay69Bundle end
struct ChromaticElement end
create_r_group(args...; kwargs...) = nothing
create_g_group(args...; kwargs...) = nothing
create_b_group(args...; kwargs...) = nothing
create_rgb_bundle(args...; kwargs...) = nothing
create_bgr_bundle(args...; kwargs...) = nothing
group_fingerprint(args...; kwargs...) = nothing
bundle_fingerprint(args...; kwargs...) = nothing
rgb_fingerprint(args...; kwargs...) = nothing
bgr_fingerprint(args...; kwargs...) = nothing
verify_rgb_bgr_equivalence(args...; kwargs...) = nothing
struct SPIProof69 end
verify_parallel_equivalence(args...; kwargs...) = nothing
verify_all_permutations(args...; kwargs...) = nothing
element_to_trit(args...; kwargs...) = nothing
group_trit_word(args...; kwargs...) = nothing
bundle_trit_word(args...; kwargs...) = nothing

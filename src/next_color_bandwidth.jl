...
struct BandwidthTest end
struct BandwidthResult end
measure_next_color_bandwidth(args...; kwargs...) = nothing
measure_at_scale(args...; kwargs...) = nothing
struct ParallelismLevel end
struct OUTER_INNER end
struct THREADED end
struct TERNARY end
struct COMPOSED end
struct WORK_STEALING end
struct MAXIMUM end
struct ULTRA end
next_color_batch(args...; kwargs...) = nothing
next_color_parallel(args...; kwargs...) = nothing
stress_bandwidth(args...; kwargs...) = nothing
find_bandwidth_limit(args...; kwargs...) = nothing
scaling_curve(args...; kwargs...) = nothing
benchmark_all_levels(args...; kwargs...) = nothing
bandwidth_comparison(args...; kwargs...) = nothing
bandwidth_spi_check(args...; kwargs...) = nothing

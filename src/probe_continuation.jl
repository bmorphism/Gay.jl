...
struct ColourGrade end
struct StrategyGalois end
probe!(args...; kwargs...) = nothing
continuation_safe(args...; kwargs...) = nothing
account_strategies(args...; kwargs...) = nothing
struct CausalCRDT end
struct CRDTState end
merge_crdt(args...; kwargs...) = nothing
causal_order(args...; kwargs...) = nothing
isolate_indeterminacy(args...; kwargs...) = nothing
struct ParallelSafetyCheck end
max_parallel_partition(args...; kwargs...) = nothing
commutes_colorgrade(args...; kwargs...) = nothing

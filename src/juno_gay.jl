...
step!(args...; kwargs...) = nothing
progress_fraction(args...; kwargs...) = nothing
struct BidirectionalDebugger end
enter!(args...; kwargs...) = nothing
step_back!(args...; kwargs...) = nothing
step_forward!(args...; kwargs...) = nothing
struct WeaveVariant end
struct CoalgebraicWeave end
weave_coalgebra(args...; kwargs...) = nothing

...
struct RegretTable end
struct StrategyProfile end
struct RevolutionGame end
struct Participant end
struct Action end
struct Outcome end
cfr_step!(args...; kwargs...) = nothing
regret_match(args...; kwargs...) = nothing
average_strategy(args...; kwargs...) = nothing
struct SpeedrunPath end
discover_equilibrium(args...; kwargs...) = nothing
parallel_cfr(args...; kwargs...) = nothing
struct ReversibleMove end
struct HysteresisCheck end
is_reversible(args...; kwargs...) = nothing
hysteresis_potential(args...; kwargs...) = nothing
verify_no_bloody_hysteresis(args...; kwargs...) = nothing

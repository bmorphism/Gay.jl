...
# Stub definitions
struct GayWire end
struct GayPolynomial end
global_sections(args...; kwargs...) = nothing
poly_coproduct(args...; kwargs...) = nothing
struct GayTask end
struct GayOutcome end
struct GayPortfolio end
portfolio_to_poly(args...; kwargs...) = nothing
struct GayBox end
struct GayAgent end
create_gay_agent(args...; kwargs...) = nothing
struct RecumbentWD end
execute_recumbent!(args...; kwargs...) = nothing
struct NeuralWD end
struct FeedbackState end

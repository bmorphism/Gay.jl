...
struct WikipediaPerson end
struct PersonCatalog end
struct ParaAfference end
struct ParaConsapevolezza end
struct ChromaticDirection end
struct HUE_ORDER end
struct SAT_ORDER end
struct LIGHT_ORDER end
rank_by_direction(args...; kwargs...) = nothing

...
gzip_bytes(args...; kwargs...) = nothing
struct GzipabilityStats end
struct GzipAdjustedScaling end
predict_loss(args...; kwargs...) = nothing
optimal_allocation(args...; kwargs...) = nothing
struct GzipWorld end
struct GzipEpisode end
struct GzipCoCone end
gzip_cocone_apex(args...; kwargs...) = nothing
gzip_episode_graph(args...; kwargs...) = nothing
predict_reconciliation(args...; kwargs...) = nothing
struct ChromaticGzip end
seed_gzipability(args...; kwargs...) = nothing

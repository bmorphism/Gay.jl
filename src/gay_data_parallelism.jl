...
gay_scan(args...; kwargs...) = nothing
gay_filter(args...; kwargs...) = nothing
gay_zip(args...; kwargs...) = nothing
gay_unzip(args...; kwargs...) = nothing
gay_partition(args...; kwargs...) = nothing
gay_parallel_map(args...; kwargs...) = nothing
gay_parallel_reduce(args...; kwargs...) = nothing
gay_chunk(args...; kwargs...) = nothing
gay_merge_chunks(args...; kwargs...) = nothing
struct SPIVerification end
verify_spi(args...; kwargs...) = nothing
spi_test_vector(args...; kwargs...) = nothing
struct RocqProof end
last_coq_version(args...; kwargs...) = nothing
